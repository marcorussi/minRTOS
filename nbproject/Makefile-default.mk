...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/minRTOS.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=src/rtos.c src/rtos_cfg.c src/tmr.c src/app_task_a.c src/app_task_b.c src/app_task_c.c src/main.c src/int.c src/exc.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/rtos.o ${OBJECTDIR}/src/rtos_cfg.o ${OBJECTDIR}/src/tmr.o ${OBJECTDIR}/src/app_task_a.o ${OBJECTDIR}/src/app_task_b.o ${OBJECTDIR}/src/app_task_c.o ${OBJECTDIR}/src/main.o ${OBJECTDIR}/src/int.o ${OBJECTDIR}/src/exc.o
POSSIBLE_DEPFILES=${OBJECTDIR}/src/rtos.o.d ${OBJECTDIR}/src/rtos_cfg.o.d ${OBJECTDIR}/src/tmr.o.d ${OBJECTDIR}/src/app_task_a.o.d ${OBJECTDIR}/src/app_task_b.o.d ${OBJECTDIR}/src/app_task_c.o.d ${OBJECTDIR}/src/main.o.d ${OBJECTDIR}/src/int.o.d ${OBJECTDIR}/src/exc.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/rtos.o ${OBJECTDIR}/src/rtos_cfg.o ${OBJECTDIR}/src/tmr.o ${OBJECTDIR}/src/app_task_a.o ${OBJECTDIR}/src/app_task_b.o ${OBJECTDIR}/src/app_task_c.o ${OBJECTDIR}/src/main.o ${OBJECTDIR}/src/int.o ${OBJECTDIR}/src/exc.o

# Source Files
SOURCEFILES=src/rtos.c src/rtos_cfg.c src/tmr.c src/app_task_a.c src/app_task_b.c src/app_task_c.c src/main.c src/int.c src/exc.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/minRTOS.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/minRTOS.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PIC32MXSK=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/minRTOS.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}              -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PIC32MXSK=1,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/minRTOS.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/minRTOS.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	${MP_CC_DIR}/xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/minRTOS.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
